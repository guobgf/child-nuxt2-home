    ...
    <div class="bg-gray-1 bg-box pt-25 pb-15">
      ...
      <div class="search-outer">
        <div class="home-search">
          <el-input v-model="homeSearchValue" :placeholder="placeholder">
            <el-select
              slot="prepend"
        ...
        <div class="classify-part">
          <div class="class-l">
            ...
            >
              <ul class="classify-2">
                <li
                  v-for="(itemLevel2, index2) in item.childList"
                  :key="index2"
                >
                  <h4 @click="toJobList(itemLevel2, 2)">
                    {{ itemLevel2.text }}
                  </h4>
                  <p>
                    <span
      ...
      <div class="w-1200-auto">
        ...
        <div class="famous-company">
          ...
          <ul class="company-list">
            <li
              v-for="(item, index) in homeData.famousEnterpriseList"
              :key="index"
            >
              <el-card>
...
.home-page {
  ...
  .h2-title {
    ...
    &::before {
      ...
      width: 30px;
      height: 30px;
      background: url(https://storage.360buyimg.com/channel2022/jd_home/0.0.16/assets/sprite/floor_hd/sprite.png) no-repeat;
